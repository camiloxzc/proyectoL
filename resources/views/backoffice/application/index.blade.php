          ...
          <div class="row">
            <div class="col-md-12">
              <div class="card">
                ...
                <h4 class="card-title">
                      {{ Form::open(['route' => 'admin.application.index', 'method' => 'GET', 'class' => 'form-inline pull-right']) }}
                ...
                <div class="card-body">
                  <div class="row">
                    <div class="col-12 text-right">
                      <a href="{{ route('admin.application.create') }}" class="btn btn-sm btn-round btn-facebook">Añadir solicitud</a>
                    </div>
                  </div>
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td class="td-actions text-right">
                            <a href="{{ route('admin.application.show', $application->idsolicitudservicio) }}" class="btn btn-sm btn-round btn-info"><i
                                class="material-icons">visibility</i></a>
                            <a href="{{ route('admin.application.edit', $application->idsolicitudservicio) }}" class="btn btn-sm btn-round btn-warning"><i
                                class="material-icons">edit</i></a>
                            <form action="{{ route('admin.application.destroy', $application->idsolicitudservicio) }}" method="POST"
